...
//        Background background = new Background(outerBackgroundFill, innerBackgroundFill);
    ...
    private void generateTeamTestData(){
        ...
        Player storm = new Player("Storm", 95,100, new Gun(), new Vest());
        Player daan = new Player("Daan", 90,100, new Gun(), new Vest());
        Player test1 = new Player("Test 1", 80,100, new Gun(), new Vest());
        Player test2 = new Player("Test 2", 90,90, new Gun(), new Vest());
        Player test3 = new Player("Test 3", 70,85, new Gun(), new Vest());
